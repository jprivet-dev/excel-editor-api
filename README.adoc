...
. In the *PHP Settings* dialog, click the Browse button kbd:[...] next to the *CLI Interpreter* list.
...
. In the *Configure Remote PHP Interpreter* dialog, click the button kbd:[OK].
. In the *CLI Interpreters* dialog, click the button kbd:[OK].
...
. In Settings dialog, click on kbd:[OK] to validate all.
